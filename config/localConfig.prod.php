...
define('GOOGLE_API_KEY', 'AIzaSyDhbMSQmEzVY0EW_hlBP3CBtPga30R9g3c');

/* Vimeo API Key */
define('VIMEO_API_KEY', '');

/* Google Analytics Tracking Code */
define('GA_TRACKING_CODE', 'UA-74231940-4');

/* Database Config */
$db_type          = 'mysql'; // 'mysql' or 'pgsql'
$db_host          = 'mariadb.production.local'; // localhost or some other domain/ip
$db_port          = '3306';
$db_user          = 'dbadmin';
$db_password      = 'hf8F5EiYob2MVcFs';
$db_name          = 'udoit';
$db_user_table    = 'users';
