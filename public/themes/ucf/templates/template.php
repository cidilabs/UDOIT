...
<html lang="en">
	<head>
		...
		<link href="themes/<?= UdoitUtils::getActiveTheme() ?>/css/main.css?v=<?= UDOIT_VERSION ?>" type="text/css" rel="stylesheet" media="screen">
		<link href="themes/<?= UdoitUtils::getActiveTheme() ?>/css/print.css?v=<?= UDOIT_VERSION ?>" type="text/css" rel="stylesheet" media="print">
	</head>
	<body>
		<div class="container">
