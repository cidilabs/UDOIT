	...
	<div class="tab-content">
		<div class="tab-pane active" id="scanner" role="tabpanel">
			...
			<form class="form-horizontal no-print" id="udoitForm" action="#" role="form">
				...
				<div class="row">
					<div class="col-sm-12 col-md-8 col-md-offset-1 ucf-accordion" aria-label="Accordion Control Group">
						<h3>
					...
					<div class="col-sm-12 col-md-3 col-md-offset-1 course_submit_container">
